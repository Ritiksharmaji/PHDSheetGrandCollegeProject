...
<%
    ...
    if (request.getParameter("sub") != null) {  
        ...
        if (rs.next()) {
            ...
            out.println("Description Objectives: " + rs.getBlob("del_impact") + "<br>");
            out.println("Description Preliminary: " + rs.getBlob("del_exp_pub") + "<br>");
            out.println("Description Innovative: " + rs.getBlob("del_mon_effective") + "<br>");
            out.println("Description Methodology: " + rs.getBlob("del_suit_gov_schemes") + "<br>");
            out.println("Description Methodology: " + rs.getBlob("del_post_proj_act") + "<br>");
